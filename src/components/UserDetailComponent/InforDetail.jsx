    ...
    <div className="">
      <div className="relative flex justify-center flex-col items-center gap-2 border-b py-7">
        {user.user.avatar == "" ? (
          ...
          <img
            src="https://fiverr-res.cloudinary.com/t_profile_thumb,q_auto,f_auto/attachments/profile/photo/c4142aba8086136b26d01a1111e60038-1594185651419/fe383003-5a03-43a1-b161-99a08401b6bd.png"
            alt=""
