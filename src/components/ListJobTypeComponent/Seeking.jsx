        ...
        <div className="block space-y-20 lg:space-y-0 lg:flex justify-between items-center border rounded-lg pl-10 py-10 2xl:py-0">
          <div>
            ...
            <div className="flex gap-3 mt-5 items-center">
              <p className="p-2 rounded-full text-[#782020] bg-[#FFEDED] text-sm font-medium">Visual Identity & Branding</p>
              <p className="p-2 rounded-full text-[#782020] bg-[#FFEDED] text-sm font-medium">Web & App Design</p>
              <p className="p-2 rounded-full text-[#782020] bg-[#FFEDED] text-sm font-medium">Marketing & Advertising</p>
              <p className="py-2 text-sm font-bold text-[#782020]">& more</p>
            </div>
            <button className="mt-6 py-2 px-4 rounded-lg text-white font-semibold bg-black">Browse agencles</button>
          </div>
