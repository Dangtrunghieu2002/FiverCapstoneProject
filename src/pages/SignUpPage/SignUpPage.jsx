...
const SignUpPage = () => {
  return (
    <div className="container flex items-center justify-center h-screen">
      <div className="w-2/3">
        <img src="https://img.lovepik.com/photo/45009/7683.jpg_wh860.jpg" className="w-[120%]" alt="" />
      </div>
      <form class="max-w-md mx-auto space-y-10 box-shadow p-10 rounded-xl">
        <h3 className="text-center font-bold text-3xl">Get Fiverr Account Now</h3>
        ...
        <h3>Already have an account? <Link className="underline text-blue-500">Sign In</Link></h3>
      </form>
    </div>
  );
};
